...
public class PrimitiveTest extends TestCase {
  ...
  public void testNumberDeserializationAsInt() {
    String json = "1.0";
    Number actual = gson.fromJson(json, Number.class);
    assertEquals(1, actual.intValue());
  }
  
  public void testNumberDeserializationIntCut() {
    String json = "2.5";
    Number actual = gson.fromJson(json, Number.class);
    assertEquals(2, actual.intValue());
  }
  
  public void testNumberDeserializationLongCut() {
    String json = "2.5";
    Number actual = gson.fromJson(json, Number.class);
    assertEquals(2L, actual.longValue());
  }
  
  public void testNumberDeserializationIntOverflow() {
    String json = "4294967299";  // 2^32 + 3
    Number actual = gson.fromJson(json, Number.class);
    assertEquals(3, actual.intValue());
  }
  
  public void testNumberDeserializationLongOverflow() {
    String json = "18446744073709551619";  // 2^64 + 3
    Number actual = gson.fromJson(json, Number.class);
